          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-transform duration-300 group-hover:scale-110 ${colorMap[service.color]} ${service.img ? 'p-2' : ''}`}>
                    {service.img ? (
                      <img src={service.img} alt={`Logo ${service.title}`} className="w-full h-full object-contain mix-blend-multiply" />
                    ) : (
      ...
      <section id="benefits" className="py-16 px-6 md:px-12 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-slate-200 rounded-2xl p-6 flex flex-col items-center text-center space-y-4 hover:border-orange-500 transition-colors duration-300">
              <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center text-[#EA580C]">
                <Target className="w-6 h-6" />
              </div>
              <h3 className="font-heading font-extrabold text-slate-900 text-lg">Pemasaran Tepat Sasaran</h3>
              <p className="text-slate-500 text-sm">Menjangkau pelanggan yang benar-benar potensial dengan penargetan audiens berdasarkan minat, perilaku, dan kebutuhan mereka.</p>
            </div>
